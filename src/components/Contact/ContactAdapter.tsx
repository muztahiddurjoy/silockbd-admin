...
const ContactAdapter = () => {
  return (
    <div className='card my-3 p-2 border border-primary/30 rounded-md [&>p]:text-primary [&>p]:text-sm [&>p]:my-1'>
      ...
      <p className=' font-semibold'>Enquiry Type : <span className='text-gray-600'>Kire mama</span></p>
      <p className=' font-semibold mb-5'>Enquiry : <span className='text-gray-600'>Kire mama</span></p>
      <p className=''>Name : <span className='text-gray-600'>Kire mama</span></p>
      <p className=''>Email : <span className='text-gray-600'>Kire mama</span></p>
      <p className=''>Company Website : <span className='text-gray-600'>Kire mama</span></p>
